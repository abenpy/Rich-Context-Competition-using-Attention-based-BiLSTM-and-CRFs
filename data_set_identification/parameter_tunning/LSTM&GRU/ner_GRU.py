...
# character GRU to get word encodings by characters
...
main_gru = Bidirectional(GRU(units=50, return_sequences=True,
...
pickle.dump(history_save, open('history_GRU', 'wb'))
