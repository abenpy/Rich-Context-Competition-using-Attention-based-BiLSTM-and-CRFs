...
sgd = optimizers.SGD(lr=0.001,  decay=1e-5)
# adam = optimizers.Adam(lr=0.001, epsilon=None, decay=1e-5)
model.compile(optimizer=sgd, loss=crf.loss_function, metrics=[crf.accuracy]) #use crf
model.summary()
...
pickle.dump(history_save, open('history_sgd', 'wb'))
